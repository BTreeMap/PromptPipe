...
func (s *Server) sendHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&p); err != nil {
		...
		writeJSONResponse(w, http.StatusBadRequest, models.NewErrorResponse("Invalid JSON format"))
		return
	}
	...
	if err := p.Validate(); err != nil {
		...
		writeJSONResponse(w, http.StatusBadRequest, models.NewErrorResponse(err.Error()))
		return
	}
	...
	if err != nil {
		...
		writeJSONResponse(w, http.StatusInternalServerError, models.NewErrorResponse("Failed to generate message content"))
		return
	}
	...
	if err != nil {
		...
		writeJSONResponse(w, http.StatusInternalServerError, models.NewErrorResponse("Failed to send message"))
		return
	}
...
func (s *Server) scheduleHandler(w http.ResponseWriter, r *http.Request) {
	...
	if p.Type == models.PromptTypeGenAI && s.gaClient == nil {
		...
		writeJSONResponse(w, http.StatusBadRequest, models.NewErrorResponse("GenAI client not configured"))
		return
	}
	...
	if p.Cron == "" {
		if s.defaultCron == "" {
			...
			writeJSONResponse(w, http.StatusBadRequest, models.NewErrorResponse("Missing required field: cron schedule"))
			return
		}
	...
	if addErr := s.sched.AddJob(p.Cron, func() {
		...
		writeJSONResponse(w, http.StatusInternalServerError, models.NewErrorResponse("Failed to schedule job"))
		return
	}
...
func (s *Server) receiptsHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		writeJSONResponse(w, http.StatusInternalServerError, models.NewErrorResponse("Failed to fetch receipts"))
		return
	}
...
func (s *Server) responseHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err := s.st.AddResponse(resp); err != nil {
		...
		writeJSONResponse(w, http.StatusInternalServerError, models.NewErrorResponse("Failed to store response"))
		return
	}
...
func (s *Server) responsesHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		writeJSONResponse(w, http.StatusInternalServerError, models.NewErrorResponse("Failed to fetch responses"))
		return
	}
