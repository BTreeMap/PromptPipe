...
func TestTwilioService_SendMessage_Receipt(t *testing.T) {
	mockClient := twiliowhatsapp.NewMockClient()
	svc := NewTwilioService(mockClient)
...
func TestTwilioWhatsAppService_StartStop(t *testing.T) {
	mockClient := twiliowhatsapp.NewMockClient()
	svc := NewTwilioService(mockClient)
...
func TestTwilioWhatsAppService_ValidateAndCanonicalizeRecipient(t *testing.T) {
	mockClient := twiliowhatsapp.NewMockClient()
	svc := NewTwilioService(mockClient)
