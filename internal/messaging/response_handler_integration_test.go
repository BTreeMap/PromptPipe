...
func TestAPIIntegration_BranchPromptResponseFlow(t *testing.T) {
...
func TestAPIIntegration_GenAIPromptResponseFlow(t *testing.T) {
	// Setup mock messaging service
	mockClient := whatsapp.NewMockClient()
	msgService := NewWhatsAppService(mockClient)
...
func TestAPIIntegration_StaticPromptNoAutoHandler(t *testing.T) {
	// Setup mock messaging service
	mockClient := whatsapp.NewMockClient()
	msgService := NewWhatsAppService(mockClient)
...
func TestAPIIntegration_InteractiveStaticPromptWithHandler(t *testing.T) {
	// Setup mock messaging service
	mockClient := whatsapp.NewMockClient()
	msgService := NewWhatsAppService(mockClient)
